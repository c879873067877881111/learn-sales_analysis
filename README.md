...
本專案使用Python進行數據處理和分析，主要依靠pandas進行數據操作和轉換。分析流程包括：
...
### 產品類別分佈
![產品類別分佈](images/category_distribution.png)  
*圖3: 產品類別銷售佔比，傢俱佔比最高(47.76%)，其次是辦公品(29.36%)。*

### 地區銷售分析
![地區銷售分析](images/geo_sales.png)  
*圖4: 歐洲地區的銷售分佈，英國市場貢獻最高利潤。*

### 客戶價值分析
![客戶價值分析](images/customer_value.png)  
*圖5: 主要客戶的銷售貢獻，Westside客戶貢獻了最大的銷售額。*
